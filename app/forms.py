...
class MonthlyTransactionForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['group'].queryset = TransactionGroup.objects.filter(group_type=self.instance.type).all()
...
class MonthlyTransactionsInlineForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk:
            self.fields['group'].queryset = TransactionGroup.objects.filter(group_type=self.instance.type)
